...
Resolution API](../glossary.md#provenance-and-content-authenticity). Registering Sigil as an approved soft binding algorithm is a far shorter
...
manifest. Sigil's premise is that the [attestation](../glossary.md#terms-sigil-defines) itself travels in the signal and verifies
offline. These are reconcilable, since a [carrier](../glossary.md#terms-sigil-defines) can hold both a self-contained attestation
