...
- Trust model. A [certificate hierarchy](../glossary.md#cryptography-and-specification) resembling [C2PA](../glossary.md#organizations-and-standards-bodies)'s, a registry of known signers, or a
  decentralized model. This is a governance decision as much as a technical one.
- [Revocation](../glossary.md#cryptography-and-specification), and specifically how revocation checking avoids reintroducing a hard network
  dependency (R10).
